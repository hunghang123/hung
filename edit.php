...
if ($m =='')
{
    ...
    <form action="update.php" method='post' entype='multipart/form-data'>
        ma: <input type="text" name='DH51800859_masach' value='<?php echo $data1->masach ?>' readonly> <br>
        ten: <input type="text" name='DH51800859_tensach' value='<?php echo $data1->tensach ?>'> <br>
        gia: <input type="number" name='DH51800859_gia' value='<?php echo $data1->gia ?>'> <br>
        Mo ta: <textarea name="DH51800859_mota" id="" cols="30" rows="10"><?php echo $data1->mota ?>
        </textarea> <br>
        Nha xb <select name="DH51800859_manxb" id="">
            <?php 
            ...
            <br>
        Loai <select name="DH51800859_maloai" id="">
            <?php 
